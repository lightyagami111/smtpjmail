...
public class MailClient extends Frame {
	...
	private Button btSend = new Button("Send");
      private Button btbox = new Button("Inbox");
	 ...
	 */
	private Checkbox usrName = new Checkbox("");
	...
	public MailClient() {
		...
		btSend.addActionListener(new SendListener());
                btbox.addActionListener(new inbox());
		btClear.addActionListener(new ClearListener());
		btQuit.addActionListener(new QuitListener());
		buttonPanel.add(btSend);
		buttonPanel.add(btClear);
		buttonPanel.add(btQuit);
                buttonPanel.add(btbox);
	...
	class SendListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			try {
				Message mailMessage = new Message(fromField.getText(), toField
						.getText(), ccField.getText(), subjectField.getText(),
						messageText.getText(), usrName.getState(), serverField
								.getText());
			...
			System.out.println("Mail sent succesfully!");
              ...
              private class inbox implements ActionListener {
                public void actionPerformed(ActionEvent e) {
                        if (e.getSource() == btbox) {

                                recMess dd = new recMess();
                                dd.setVisible(true);
